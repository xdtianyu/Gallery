...
if [ -z "$encrypted_151cd4732554_key" ] ; then
    ...
    export encrypted_151cd4732554_key="12CF1B5E0D192628AA922230549EEDFD889E6CF7463933C6DABD9A1300FCA23D"
    export encrypted_151cd4732554_iv="66813CF28D04CD129D57436B78DECBA4"
